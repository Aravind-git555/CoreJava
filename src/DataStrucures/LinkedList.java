...
class LinkedList {
	...
	public static void main(String[] args) {
		...
		do {
			...
			case 1:
				System.out.println("\nenter the value ");
				list.head = list.insertInEnd(in.nextInt(), list.head);
				break;
			case 2:
				System.out.println("\nenter the value");
				list.head = list.insertInBeg(in.nextInt(), list.head);
				break;
			case 3:
				System.out.println("\nenter the value");
				list.head = list.insertAtPos(in.nextInt(), in.nextInt(), list.head);
				break;
			case 4:
